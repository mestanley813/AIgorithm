...
class Account(object):
    ...
    def placeBuyOrder(self, ticker):
        ...
        try:
            closedPosition = closedPosition[0]["client_order_id"]
        except:
            pass
        else:
            time.sleep(15)
            sellPrice = self.api.get_order_by_id(closedPosition)[0]["filled_avg_price"]
            updateDB(sellPrice)
        ...
        try:
            ...
            self.current_order = self.api.submit_order(order_data=market_order_data)
